...
sklearn2pmml(LR_pipeline, "PMML Files/LogisticRegression_HeartDisease.pmml", with_repr = True)
...
tree = elt.parse("PMML Files/LogisticRegression_HeartDisease.pmml")
...
recall_calc = elt.SubElement(child, 'recall calculation')
...
precision_calc = elt.SubElement(child, 'precision calculation')
...
DataProcessing = elt.SubElement(child, "Data Processing")
DataProcessing.set('train/test ', '80/20 split')
DataProcessing.tail = '\n'

xmlRoot.append(child)
elt.dump(xmlRoot)
tree.write("PMML Files/LogisticRegression_HeartDisease.pmml", encoding = "UTF-8")
...
tree = elt.parse("PMML Files/DecisionTree_HeartDisease.pmml")
xmlRoot = tree.getroot()
child = elt.Element("ModelEvaluation")
child.tail = '      \n    '
...
xmlRoot.append(child)
elt.dump(xmlRoot)
tree.write("PMML Files/DecisionTree_HeartDisease.pmml")
