...
tree = elt.parse("PMML Files/DecisionTree_BreastCancer.pmml")
...
elt.dump(xmlRoot)
tree.write("PMML Files/DecisionTree_BreastCancer.pmml")
...
sklearn2pmml(LR_pipeline, "PMML Files/LogisticRegression_BreastCancer.pmml", with_repr = True)

#Add Performance Metrics to LR PMML
elt.register_namespace('', "http://www.dmg.org/PMML-4_4")
elt.register_namespace('xmlns:data', "http://jpmml.org/jpmml-model/InlineTable")

tree = elt.parse("PMML Files/LogisticRegression_BreastCancer.pmml")
xmlRoot = tree.getroot()
child = elt.Element("ModelEvaluation")
child.tail = '      \n    '
...
xmlRoot.append(child)
elt.dump(xmlRoot)
tree.write("PMML Files/LogisticRegression_BreastCancer.pmml")
